...
- `Velocity плохо работает, если вкл block collision, часто когда рядом с блоками начинает на месте флагать, а без него фейз не работает, впрочем фейз у меня на сервере не работает в целом даже с включенной этой настройкой`
